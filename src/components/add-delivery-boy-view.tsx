...
interface AddDeliveryBoyViewProps {
  manager: User;
}
...
export default function AddDeliveryBoyView({ manager }: AddDeliveryBoyViewProps) {
  ...
  const handleSendOtp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        title: "OTP Sent",
        description: `An OTP has been sent to the new delivery boy's mobile number (${mobileNumber}).`,
      });
      setStep('otp');
  ...
  const handleVerifyAndCreateUser = async (e: React.FormEvent) => {
    ...
    const tempAppName = `delivery-boy-signup-${Date.now()}`;
  ...
  return (
    <Card className="w-full max-w-lg mx-auto">
      <CardHeader>
        ...
        <CardDescription>Enter the new delivery boy's details. They will be added to your team and branch.</CardDescription>
      </CardHeader>
      <CardContent>
