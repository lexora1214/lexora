...
interface AddBranchManagerViewProps {
  manager: User;
}

export default function AddBranchManagerView({ manager }: AddBranchManagerViewProps) {
  ...
  const handleSignup = async (e: React.FormEvent) => {
    ...
    const tempAppName = `branch-manager-signup-${Date.now()}`;
    ...
    try {
      ...
      toast({
        title: "Branch Manager Registered",
  ...
  return (
    <Card className="w-full max-w-lg mx-auto">
      <CardHeader>
        ...
        <CardDescription>Enter the new branch manager's details. They will be added to your team and branch.</CardDescription>
      </CardHeader>
      <CardContent>
